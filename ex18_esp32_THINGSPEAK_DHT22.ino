...
#define DHT_PIN 13      // Define o pino para a conexão do sensor DHT11 (altere se necessário)

DHT dht(DHT_PIN, DHT22);// Cria um objeto para controlar o sensor DHT11. Caso use o DHT22, troque a constante DHT11 para DHT22
...
void loop()
{
  ...
  ThingSpeak.setField(1, dht.readTemperature());  // Define o valor para a campo 1 no ThingSpeak
  ThingSpeak.setField(2, dht.readHumidity());     // Define o valor para a campo 2 no ThingSpeak
